...
namespace {
    ...
    public:
        ...
        size_t get_description(
            ...
            if (displacement != 0) {
                constexpr static size_t max_disp_num = sizeof("+0x1122334455667788") - 1; // maximum possible offset
        ...
        size_t address_to_string(
            ...
            if (line != 0) {
                constexpr static size_t max_line_num = sizeof("(4294967295): ") - 1; // maximum possible line number
...
void __stdcall __std_stacktrace_to_string(const void* const* const _Addresses, const size_t _Size, void* const _Str,
    ...
    for (size_t i = 0; i != _Size; ++i) {
        ...
        constexpr static size_t max_entry_num = sizeof("65536> ") - 1; // maximum possible entry number
